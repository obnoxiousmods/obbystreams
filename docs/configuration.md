...
- `event_refresh_interval_seconds`: legacy private-loop event cadence. The schedule's
  `acquisition_poll_seconds` controls the authoritative 180-second acquisition cadence.
